...
#
"""
Helper script to generate mysql config from tunable parameters JSON.

Run: `./generate_mysql_config.py ./input-params.json ./output-mysql.cfg`
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="generate mysql config from tunable parameters JSON.")
    parser.add_argument("input", help="JSON file with tunable parameters.")
    parser.add_argument("output", help="Output mysql config file.")
